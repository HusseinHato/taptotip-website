    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-6 sm:py-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                ...
                <div className={`sm:col-span-2 lg:col-span-3 rounded-2xl p-6 sm:p-8 border-2 transition-all ${hasValidDelegation
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div className="flex items-start gap-4">
                            <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center flex-shrink-0 ${hasValidDelegation ? 'bg-green-500' : 'bg-amber-500'
                                }`}>
                                {hasValidDelegation ? (
                            ...
                            <div>
                                <h2 className={`text-xl sm:text-2xl font-bold mb-1 ${hasValidDelegation ? 'text-green-900' : 'text-amber-900'
                                    }`}>
                                    {hasValidDelegation ? 'Authorization Active' : 'Authorization Required'}
                                </h2>
                                <p className={`text-sm sm:text-base ${hasValidDelegation ? 'text-green-700' : 'text-amber-700'
                                    }`}>
                                    {hasValidDelegation
                ...
                <div className={`bg-gradient-to-br from-red-50 to-rose-50 rounded-2xl p-6 border-2 transition-all ${hasValidDelegation
                        ? 'border-red-200 hover:border-red-400 hover:shadow-xl cursor-pointer'
                        : 'border-red-200 opacity-60 cursor-not-allowed'
                    }`}>
                    <div className="flex flex-col h-full justify-between">
                        <div>
                            <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center mb-4 ${hasValidDelegation
                            ...
                            <h3 className={`text-xl sm:text-2xl font-bold mb-2 ${hasValidDelegation ? 'text-gray-900' : 'text-gray-500'
                                }`}>
                                Revoke Access
                            </h3>
                            <p className={`text-sm sm:text-base ${hasValidDelegation ? 'text-gray-700' : 'text-gray-500'
                                }`}>
                                {hasValidDelegation
